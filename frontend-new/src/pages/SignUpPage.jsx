...
import { Camera, TreePine, Mail, Lock, Eye, EyeOff, User } from "lucide-react";
      ...
      <div className="w-full max-w-md relative">
            ...
            <CardHeader className="text-center space-y-4">
              ...
              <div>
                ...
                <CardDescription className="text-muted-foreground">
                  Connect with wildlife photographers and nature enthusiasts
                </CardDescription>
              </div>
            </CardHeader>
        ...
        >
          <p className="text-xs text-muted-foreground/70">
            Join thousands of wildlife photographers worldwide
          </p>
        </motion.div>
      </div>
    </div>
